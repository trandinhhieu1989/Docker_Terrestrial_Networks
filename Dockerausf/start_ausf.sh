...
NRF_CONFIG=/free5gc/config/ausfcfg.yaml
...
sed -i "8s/127.0.0.9/$IP_ADDRESS/" $NRF_CONFIG
sed -i "9s/127.0.0.9/$IP_ADDRESS/" $NRF_CONFIG

sed -i "16s/127.0.0.10/$NRF_IP/" $NRF_CONFIG
