...
#docker run --name mongodb --ip 172.18.0.2 --network hieunetwork -p 27017:27017 -e MONGO_INITDB_ROOT_USERNAME=admin -e MONGO_INITDB_ROOT_PASSWORD=adminpass -e MONGO-AUTHDB=admin -dit mongo:latest
...
python3 /media/hieu/E/Hieu/Dockerfree5gc_github/Pymongo/pymongo_webconsole.py
