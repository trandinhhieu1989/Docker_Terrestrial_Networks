...
NRF_CONFIG=/free5gc/config/udmcfg.yaml
...
sed -i "14s/127.0.0.3/$IP_ADDRESS/" $NRF_CONFIG
sed -i "15s/127.0.0.3/$IP_ADDRESS/" $NRF_CONFIG
sed -i "20s/127.0.0.10/$NRF_IP/" $NRF_CONFIG
#sed -i "29s/localhost/$MONGO_IP/" $NRF_CONFIG
