...
NRF_CONFIG=/free5gc/config/amfcfg.yaml
...
sed -i "8s/127.0.0.18/$IP_ADDRESS/" $NRF_CONFIG
sed -i "12s/127.0.0.18/$IP_ADDRESS/" $NRF_CONFIG
sed -i "13s/127.0.0.18/$IP_ADDRESS/" $NRF_CONFIG
